...
const Home = () => {
  ...
  return (
    <div className='max-w-7xl gap-14 mx-auto my-10'>
      ...
      <label htmlFor="countries" className=" mb-2 text-sm font-medium text-gray-900 dark:text-white">Sort By :</label>
      <select onChange={(e)=>e.target.value==="first"?dispatch(sort_f_upload()):dispatch(sort_l_upload())}  id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 mb-2  p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
